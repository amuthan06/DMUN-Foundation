...
import { newsroomArticles } from "../data/newsroomArticles";
...
const pageData = [
  ...
  },
  {
    title: "Article Page",
    path: "/newsroom/:id",
    content: ["Article", "News", "Press Release", "Event", "Update"].join(" "),
  },
  {
    title: "Test Page",
    path: "/test",
    content: ["Test Page", "Sample Content", "Testing"].join(" "),
  },
];

// Add Newsroom articles as searchable content
const articleData = newsroomArticles.map((article) => ({
  title: article.title,
